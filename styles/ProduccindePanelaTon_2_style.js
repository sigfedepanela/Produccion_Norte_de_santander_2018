...
var style_ProduccindePanelaTon_2 = function(feature, resolution){
    ...
    if (value >= 4.340000 && value <= 301.130000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 301.130000 && value <= 696.840000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 696.840000 && value <= 1357.970000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1357.970000 && value <= 3899.210000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3899.210000 && value <= 12334.620000) {
            style = [ new ol.style.Style({
